...
public class SwipeLayout extends FrameLayout {
    ...
    public void addRevealListener(View childId, OnRevealListener l) {
        View child = childId;
        if (child == null) {
    ...
    public void addRevealListener(int[] childIds, OnRevealListener l) {
        for (int i : childIds)
            addRevealListener(findViewById(i), l);
    }
     ...
     * {@link com.sumit1334.swipeactionview.SwipeLayout.ShowMode}.PullOut and
     * {@link com.sumit1334.swipeactionview.SwipeLayout.ShowMode}.LayDown.
     *
     * @param mode
     */
     ...
     * get the open status.
     *
     * @return {@link com.sumit1334.swipeactionview.SwipeLayout.Status} Open , Close or
     * Middle.
     */
